...
2. Client creates a job with milestones on StellarGig
3. Client funds the on-chain escrow (Freighter signs; atomic ICC updates job status)
4. Freelancer accepts the job
5. Freelancer submits a milestone with work proof
6. Client approves → Escrow automatically releases payment to freelancer wallet
